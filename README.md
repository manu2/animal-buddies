...
This repository contains the static offline game, authored content, state engine, tests and development records. Read [docs/README.md](docs/README.md) before working. Animal artwork: OpenMoji, CC BY-SA 4.0; see credits.txt.


## Animal stories
Level 2: two animated picture choices, cow/dog/rabbit walking, eating or sleeping. Both choices are valid. Recorded English sentences and optional Hindi support work offline. No microphone or speech recognition. Each animation stops after a short demonstration. Parent models language without requiring repetition. Six turns or the selected time limit; previous session deadlines survive updates. Artwork prompts: ARTWORK.md.
...
Lakeside School pilot: cow/rabbit heroes; greeting, help, water episodes; Explore/Listen support. The main screen gives equal access to Level 1 animal names, Level 2 original animated actions, and Level 3 an animal-led day. Rabbit and Cow follow authored morning, school and home/bedtime chapters; school is one setting within that story. Earlier sentence and alphabet activities remain available. Progress stays local, with optional parent observations separate from mission completions. See docs/DECISIONS.md, docs/ISSUES.md, docs/VERIFICATION.md and docs/RELEASES.md for direction and release evidence. Run tests/release.cjs and tests/upgrade.cjs with Playwright/Chrome available.
