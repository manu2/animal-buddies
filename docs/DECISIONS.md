...
Status: direction correction required after user review, 2026-09-20. The school pilot passed technical checks but FAILED the intended level-based, animal-led day experience. See ANIMAL_DAY_PLAN.md; that correction is not yet implemented.
...
| D03 | Short calm visits; six completed turns or selected 3/5/7 minute wall-clock limit shared by all activities | Switching activity/hero never grants more time or turns |
...
| D07 | Local next-day unlock; parent instant restart and day simulation | Offline midnight, reopen, old storage migration and same-day lock tests |
...
| D10 | Animal-led stories: select a protagonist and replay familiar daily routines across settings; school is one chapter | Same animal wakes, gets ready, travels, meets friends and returns home; routine actions and simple language connect episodes. NOT YET DELIVERED |
