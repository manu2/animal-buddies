...
| D08 | Preserve every existing activity; free movement between illustrated activities and characters | Names, actions, sentences and letters remain available; no hard progression locks |
...
| D10 | Separate character, location and learning support; repeat familiar language with small variations | Pilot cow/rabbit, dog teacher, school beside lake; Explore/Listen support; no character resets |
...
Future, not delivered in this pilot: home routines, garden/picnic and lake/playground locations; puppy hero; turn-taking; two-step and retelling support. Locations are reusable settings, not compulsory level gates. Alphabet play remains optional.
