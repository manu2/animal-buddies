...
AUDIT_2026_09_21.md records the latest concrete usability/reliability findings and their checks; read it for related changes. ANIMAL_DAY_PLAN.md records the correction history. ARTWORK.md and ARTWORK_ROUTINES.md record generation prompts and provenance. The source of truth for authored runtime nodes is content/day.js; for recorded speech it is voice-recordings.json. A documented future feature is not a shipped feature.
